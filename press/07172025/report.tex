...
\begin{frame}{lockdep.h: Estruturas de Dados}
  \begin{itemize}
    \item lock_node_t: Grafo (children) + lista (next); dono (current_held_lock).
  \end{itemize}
  \lstinputlisting[language=C, firstline=29, lastline=37]{\cHeader} % Ajuste linhas para trecho chave
\end{frame}
...
\begin{frame}{lockdep.h: Estruturas de Dados}
  \begin{itemize}
    \item adjacency_locks_t: Edges para dependências.
  \end{itemize}
  \lstinputlisting[language=C, firstline=40, lastline=43]{\cHeader} % Ajuste linhas para trecho chave
\end{frame}
...
\begin{frame}{lockdep.h: Estruturas de Dados}
  \begin{itemize}
    \item held_lock_t: Pilha de holds com trace e timestamp.
  \end{itemize}
  \lstinputlisting[language=C, firstline=45, lastline=53]{\cHeader} % Ajuste linhas para trecho chave
\end{frame}
...
\begin{frame}{lockdep.h: Estruturas de Dados}
  \begin{itemize}
    \item thread_context_t: Contexto thread com pilha held.
  \end{itemize}
  \lstinputlisting[language=C, firstline=55, lastline=62]{\cHeader} % Ajuste linhas para trecho chave
\end{frame}
