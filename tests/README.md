...
LD_PRELOAD=./liblockdep_interpose.so ./simple_test

# Or with ptrace-based monitoring
./ptrace-lockdep --all-threads ./deadlock_test
```
...
4. **three_thread_deadlock_test.c**
